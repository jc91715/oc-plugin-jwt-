...
namespace  Jcc\Jwt\Services\Enums;

use Jcc\Jwt\Contracts\Enums\LocalizedEnumContract;
use Jcc\Jwt\Support\Enum\Enum;
use Illuminate\Http\Response as HttpResponse;
use ReflectionClass;
use ReflectionException;

class ResponseEnumsService extends Enum implements LocalizedEnumContract
{
    // 定制/覆盖 HTTP 协议状态码
    const HTTP_OK = 200;
    ...
    const CLIENT_PARAMETER_DOT_EXIST_ERROR = 400004;
    const CLIENT_TO_QUICKLY_ERROR = 400005;
    const CLIENT_CODE_ERROR = 400006;
    const CLIENT_VALIDATION_ERROR = 401001;
